...
class KNAPSACK:
    def __init__(self, top=None):
        ...
        # Function to able which algorithm of  GA or DE on 0-1 knapsack
        def SelectedAlgorithm():
            ...
            if i == 1 or j == 1:
               if i == 1:
                     ChoosedIndiv = knapsack_GA.knapsack_GA().run(items , int(weigthNum) , 20)
                     return ChoosedIndiv 
               elif j == 1:
                     ChoosedIndiv = knapsack_DA.knapsack_DA().run(items , int(weigthNum) , 20)
                     return ChoosedIndiv 
            else :
        ...
        self.totalValue.configure(foreground="#000000")
        ...
        self.totalValueNum.configure(foreground="#000000")
        self.totalValueNum.configure(insertbackground="black")
